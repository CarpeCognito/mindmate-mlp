...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-bottom-32 after:left-1/2 after:-z-10 after:h-[320px] after:w-[320px] after:-translate-x-1/2 after:bg-grid-slate-900 after:content-[''] dark:after:bg-grid-zinc-900/25 lg:static lg:h-auto lg:w-auto lg:bg-none">
        <Image
